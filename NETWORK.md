...
**ai-agent-swarm** — coordinate multiple AI agents as a unified swarm. Part of the Zion Tech Group app network (630+ apps).
...
## Related apps
- [ai-agent-swarm-v2](https://github.com/Zion-support/ai-agent-swarm-v2) — swarm v2 with consensus
...
- [zion-agentforge](https://github.com/Zion-support/zion-agentforge) — agent design & governance
